...
public abstract class JobShopExperiment extends Experiment {
	...
	//2019-03-01 Lingxuan Liu define a new factor to accept full rules
	private PR[] solutionVector;
	...
	public JobShopExperiment clone() throws CloneNotSupportedException {
		...
		clone.solutionVector = TypeUtil
				.deepCloneArrayIfPossible(solutionVector);
