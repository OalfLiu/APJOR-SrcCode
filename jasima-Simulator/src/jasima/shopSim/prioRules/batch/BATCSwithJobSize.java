 ...
 * @version "$Id$"
 */
public class BATCSwithJobSize extends ATCS {

	private static final long serialVersionUID = -1515862598920923584L;

	public BATCSwithJobSize(double k1, double k2) {
		super(k1, k2);
	}
	...
	public double calcPrio(PrioRuleTarget prt) {
		...
		double temp = (double) prt.fullnessOfBatch();
		return Math.log(prt.getWeight() / prt.currProcTime())
				+ prod1
				+ prod2
				+ Math.log(1.0/(double) prt.fullnessOfBatch());
	}
