...
public class DynamicShopExperiment extends JobShopExperiment {
	...
	private int targetObjective = 11;
	private int warmupPeriod = 500;
	...
	@Override
	public DynamicShopExperiment clone() throws CloneNotSupportedException {
		DynamicShopExperiment clone = (DynamicShopExperiment) super.clone();
		
		

		if(dueDateFactor != null)
			clone.dueDateFactor = dueDateFactor.clone();
		if(weights != null)
		clone.weights = weights.clone();
		if(procTimes != null)
		clone.procTimes = procTimes.clone();
	...
	public int getTargetObjective() {
		return this.targetObjective;
	}
	public void setTargetObjective(int targetObjective) {
		this.targetObjective = targetObjective;
	}
	
	public int getWarpupPeriod() {
		return this.warmupPeriod;
	}
	public void setWarpupPeriod(int length) {
		this.warmupPeriod = length;
	}
