...
import jasima.core.experiment.OCBAExperiment.ProblemType;
import jasima.core.experiment.OCBA_DynamicJSP_Experiment.ProblemTypeNew;
...
public class OCBATest {
	...
	public static void main2(String[] args)
	{
		...
		he.setNumMachines(10);
		he.setNumOps(10, 10);
		he.setDueDateFactor(new DblConst(4.0));
		he.setUtilLevel(0.95d);
		he.setStopAfterNumJobs(2500);
		he.setScenario(Scenario.JOB_SHOP);
		he.setMaxJobsInSystem(500);
		 
		  // create OCBA experiment
		 OCBA_DynamicJSP_Experiment ocbaExperiment = new OCBA_DynamicJSP_Experiment();
		  ...
		  ocbaExperiment.AddDR(new SPT());
		  ocbaExperiment.AddDR(new WINQ());
//		  ocbaExperiment.addFactor("sequencingRule",
//		  		new PTPlusWINQPlusNPT().setFinalTieBreaker(new TieBreakerFASFS()));
		  
		  // define objective function
		  ocbaExperiment.setObjective(EJobShopObjectives.MeanFlowTime);
		  ocbaExperiment.setProblemType(ProblemTypeNew.MINIMIZE);
	...
	public static void main3(String[] args)
	{
		...
		// set base experiment to use
		ocbaExperiment.setBaseExperiment(he);
		ocbaExperiment.setAllowParallelExecution(false);
...
//				.setFinalTieBreaker(new TieBreakerFASFS()));
		...
		// define objective function
		ocbaExperiment.setObjective("flowtime");
		ocbaExperiment.setProblemType(ProblemType.MINIMIZE);

		// no fixed budget, run until we are pretty sure to have the best
		// configuration
		ocbaExperiment.setNumReplications(200);
		ocbaExperiment.setPcsLevel(0.95);
		ocbaExperiment.setProduceAveragedResults(true);
