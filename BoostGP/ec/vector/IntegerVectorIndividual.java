...
public class IntegerVectorIndividual extends VectorIndividual
    ...
    public void setup(final EvolutionState state, final Parameter base)
        ...
        //2019-03-08 lingxuan liu 
        fixedNodeNum = state.parameters.getInt(new Parameter("pop.subpop.0.fix"), null);
        }
...
//                point = state.random[thread].nextInt((len / s.chunksize)+1);
            ...
            case VectorSpecies.C_ANY_POINT:
            	//2019-03-08 lingxuan liu fixedNodeNum
                for(int x=fixedNodeNum;x<len/s.chunksize;x++) 
    ...
    public void defaultMutate(EvolutionState state, int thread)
        ...
        IntegerVectorSpecies s = (IntegerVectorSpecies) species;
        //2019-03-08 lingxuan liu fixedNodeNum
        for(int x = fixedNodeNum; x < genome.length; x++)
